...
lyr_Colonias333_2.set('fieldLabels', {'ENT': 'no label', 'CVEDT': 'no label', 'NOMDT': 'no label', 'DTTOLOC': 'no label', 'CVEUT': 'no label', 'NOMUT': 'inline label', 'POB2010': 'no label', 'ID': 'no label', 'Fecha': 'no label', 'Clave Colo': 'no label', 'Alcaldia': 'no label', 'Nombre': 'no label', 'colonia333': 'no label', });
