...
map.getView().fit([-11046664.578541, 2194519.599800, -11020328.153853, 2209568.967710], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Robo a vehículo y motocicleta (con y sin violencia) 1 enero al 23 de diciembre 2024</h2>';
        return titleElement;
    })(),
